      ...
      passwordMessage(font, "", 15)
{
    ...
    // Setup buttons - sử dụng API của Button class
    ...
    menuItem1.setFillColor(Color(65, 135, 220, 255)); // Active - xanh sáng nổi bật
    menuItem1.setTextColor(Color::White); // Text trắng

    menuItem2.setFillColor(Color(35, 55, 85, 220)); // Inactive - navy tối
    menuItem2.setTextColor(Color(180, 195, 215)); // Text xám nhạt

    menuItem3.setFillColor(Color(35, 55, 85, 220)); // Inactive - navy tối
    menuItem3.setTextColor(Color(180, 195, 215)); // Text xám nhạt
...
void AccountScreen::setCurrentUser(const std::string& email) {
    ...
    if (currentUser) {
        ...
        // Hiển thị: CHUYỂN UTF-8 -> sf::String và set vào Text widgets
...
void AccountScreen::updatePositions(Vector2u windowSize) {
    ...
    // Save button for personal info - căn trái với input
    ...
    // Change password button - căn trái với input
...
void AccountScreen::update(Vector2f mousePos, bool mousePressed, const Event* event, AppState& state) {
    ...
    Color normalColor23 = Color(35, 55, 85, 220);  // Inactive color for items 2&3
    
    menuItem1.update(mousePos, mousePressed, hoverColor, normalColor1);
    menuItem2.update(mousePos, mousePressed, hoverColor, normalColor23);
    menuItem3.update(mousePos, mousePressed, hoverColor, normalColor23);
    ...
    if (mousePressed) {
        if (menuItem1.isClicked(mousePos, mousePressed)) {
            ...
            menuItem1.setFillColor(Color(65, 135, 220, 255)); // Active
            menuItem1.setTextColor(Color::White);
            
            menuItem2.setFillColor(Color(35, 55, 85, 220)); // Inactive
            menuItem2.setTextColor(Color(180, 195, 215));
            
            menuItem3.setFillColor(Color(35, 55, 85, 220)); // Inactive
            ...
            menuItem1.setFillColor(Color(35, 55, 85, 220)); // Inactive
            menuItem1.setTextColor(Color(180, 195, 215));
            
            menuItem2.setFillColor(Color(65, 135, 220, 255)); // Active
            ...
            menuItem3.setFillColor(Color(65, 135, 220, 255)); // Active
    ...
    // Update buttons using Button class - cần 4 tham số
